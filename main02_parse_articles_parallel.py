...
def parallel_parse(fn, nlp_eng, output_path):
    # See https://spacy.io/api/language#pipe for how I'm incorporating metadata here
    statement_list = []
    path_fn = os.path.join(output_path, "01_artsplit/", fn)
    ...
    parses_fpath = os.path.join(output_path,"02_parsed_articles",fn[:-4] + "pkl") 
...
if __name__ == "__main__":
    ...
    #spacy.prefer_gpu()
    if sys.argv[1].endswith("eng.json"):
        print (sys.argv[1], sys.argv[2])
        parse_articles(sys.argv[1], sys.argv[2])    
