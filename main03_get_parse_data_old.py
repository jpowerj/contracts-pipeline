...
def extract_pdata(pl, pdata_path):
    ...
    chunk_num = 0
    pdata_rows = []
    batched_filenames = ["02_canadian_parsed_%d.pkl" % i for i in range(23)]
    for statement_data in pl.pbar(pl.stream_parses(parses_fpath=batched_filenames), total=num_to_process):
