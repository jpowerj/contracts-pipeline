...
def sum_auth_df(pl, auth_df):
    ...
    # by sum_auth()
    # 05_canadian_authsums_sections.pkl
    #outpath = pl.get_authsums_fpath_sections(extension="pkl")
    #articles_df = grp_df.groupby(["contract_id", "article_num"]).sum()
    #articles_df.to_pickle(outpath)
