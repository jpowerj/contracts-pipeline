...
if __name__ =="__main__":
    # CORPUS_PATH=/home/dominsta/Dropbox/ash-macleod-naidu/Canadian-Contracts/data
    pipeline = Pipeline("canadian", force_overwrite=True, batch_range=2000, parallel_parsing=True)
    steps = ["compute_weights", "construct_subnorm_auths",  "weight_auth_measures", "sum_weighted_auths", "generate_auth_graphs"]
    test.run_lda(steps=steps)
